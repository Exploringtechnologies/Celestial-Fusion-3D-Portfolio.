    ...
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      >
        ...
        <div>
          ...
          Crafting Full Stack & Mobile Apps, Enchanting UIs, <br className='sm:block hidden' />
          and Captivating Video Edits
          </p>
        </div>
      </div>
<div className='relative w-full h-screen mx-auto top-[10px]'>
<ComputersCanvas />
